...
const UserSearchPage = lazy(() => import('../user/search'));
const UserBookingsPage = lazy(() => import('../user/bookings'));
const UserPaymentsPage = lazy(() => import('../user/payments'));
const UserReviewsPage = lazy(() => import('../user/reviews'));
const UserLoyaltyPage = lazy(() => import('../user/loyalty'));
const ManagerDashboardPage = lazy(() => import('../manager/dashboard'));
const ManagerAddHotelPage = lazy(() => import('../manager/add-hotel'));
const ManagerReviewReplyPage = lazy(() => import('../manager/review-reply'));
const AdminDashboardPage = lazy(() => import('../admin/dashboard'));
const AdminApproveHotelsPage = lazy(() => import('../admin/approve-hotels'));
const AdminUsersDetailsPage = lazy(() => import('../admin/users-details'));
const menuByRole = {
  user: [
